"""
Django settings for CWBAPP project.
...
INSTALLED_APPS = [
    'CWBDataApp.apps.CwbdataappConfig',
...
WSGI_APPLICATION = 'CWBAPP.wsgi.application'


# Database
# https://docs.djangoproject.com/en/3.2/ref/settings/#databases
#add secret key password
DATABASES = {
    'default': {
