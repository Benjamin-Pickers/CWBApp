...
class Batchcosttracking(models.Model):
    batchname = models.ForeignKey('Mixingform', models.DO_NOTHING, db_column='BatchName', primary_key=True)  # Field name made lowercase.
...
class Ordersheetmachine1(models.Model):
    ...
    boardprofile = models.ForeignKey('Productinventory', models.DO_NOTHING, db_column='BoardProfile')  # Field name made lowercase.
    colour = models.ForeignKey('Productinventory', models.DO_NOTHING, db_column='Colour')  # Field name made lowercase.
...
class Productinventory(models.Model):
    productname = models.ForeignKey('Productprofiles', models.DO_NOTHING, db_column='ProductName', primary_key=True)  # Field name made lowercase.
    colour = models.ForeignKey('Productprofiles', models.DO_NOTHING, db_column='Colour')  # Field name made lowercase.
