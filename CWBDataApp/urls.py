...
urlpatterns = [
    ...
    path('ChangeBatch/', views.ChangeBatch, name='ChangeBatch'),
    ...
    path('ProductInventoryPdf/', views.ProductInventoryPdf, name='ProductInventoryPdf'),
    ...
    path('MaterialInventoryPdf/', views.MaterialInventoryPdf, name='MaterialInventoryPdf'),
    ...
    path('OrdersExcel/', views.OrdersExcel, name='OrdersExcel'),
    path('UpdateOrders/', views.UpdateOrders, name='UpdateOrders'),
    path('RemoveOrder/', views.RemoveOrder, name='RemoveOrder'),
    path('UpdateDDOrders/', views.UpdateDDOrders, name='UpdateDDOrders'),
    ...
    path('PicSumView/', views.PicSumView, name='PicSumView'),
    path('PicSumUpdate/', views.PicSumUpdate, name='PicSumUpdate'),
    path('PicSumForms/', views.PicSumForms, name='PicSumForms'),
    path('PicSumDoc/', views.PicSumDoc, name='PicSumDoc'),
    path('PicSumChange/', views.PicSumChange, name='PicSumChange'),
    path('GetPicSum/', views.GetPicSum, name='GetPicSum'),
